...
|} };
  ...
  [%expect
    {|
    2:1   Identifier("int")       lexeme="int"
    2:5   Identifier("foo")       lexeme="foo"
    2:8   LeftParen               lexeme="("
    2:9   RightParen              lexeme=")"
    2:10  Semicolon               lexeme=";"
    2:1   Identifier("int")       lexeme="int"
    2:5   Identifier("bar")       lexeme="bar"
    2:8   LeftParen               lexeme="("
    2:9   RightParen              lexeme=")"
    2:10  Semicolon               lexeme=";"
    2:1   Identifier("int")       lexeme="int"
    2:5   Identifier("baz")       lexeme="baz"
    2:8   LeftParen               lexeme="("
    2:9   RightParen              lexeme=")"
    2:10  Semicolon               lexeme=";"
    6:1   Identifier("int")       lexeme="int"
    6:5   Identifier("main")      lexeme="main"
